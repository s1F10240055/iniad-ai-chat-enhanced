    ...
    <div className="message-bubble-wrapper assistant">
      ...
      <div className="message-body">
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
          ...
          {onStop && (
            <button type="button" className="chat-input-button stop-button" onClick={onStop} aria-label="Stop generation" title="生成を停止" style={{ alignSelf: "center", marginBottom: 0 }}>
